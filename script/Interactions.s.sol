...
contract CreateSubscription is Script {
    ...
    function createSubscription(address vrfCoordinator, address account) public returns (uint256, address) {
        console2.log("Create subscription on chain id: %s", block.chainid);
...
contract FundSubscription is Script, CodeConstants {
    ...
    function fundSubscription(address vrfCoordinator, uint256 subscriptionId, address linkToken, address account)
        public
    {
        console2.log("Fund subscription: ", subscriptionId);
...
contract AddConsumer is Script {
    ...
    function addConsumer(address contractToAddToVrf, address vrfCoorinator, uint256 subId, address account) public {
        console2.log("Add consumer contract: ", contractToAddToVrf);
        console2.log("To vrfCoordinator: ", vrfCoorinator);
        console2.log("On ChainId", block.chainid);
        vm.startBroadcast(account);
        VRFCoordinatorV2_5Mock(vrfCoorinator).addConsumer(subId, contractToAddToVrf);
        vm.stopBroadcast();
    }
}
